...
<html lang="en">
    ...
    <%        if (request.getParameter("apply") != null) {
            String insS = "INSERT INTO `tbl_candidate`(`student_id`, `notification_id`,`candidate_date`) VALUES "
                    + "('" + session.getAttribute("uid") + "','" + request.getParameter("apply") + "',curdate())";
    %>

    <script>
        var applyConfirmation = confirm("Do you want to apply?");
        if (applyConfirmation) {
        <% if (con.executeCommand(insS)) {
        %>
    ...
    <body onload="loadPage()">
        ...
        <div class="view-wrapper is-sidebar-v1 is-fold">
                            ...
                            <div class="nav-drop is-account-dropdown">
                                <div class="inner">
                                    <div class="nav-drop-header">
                                        <span class="studentname"><%=session.getAttribute("uname")%></span>
            ...
            <div id="main-feed" class="container sidebar-boxed" data-open-sidebar data-page-title="Timeline">
                ...
                <%
                    String selNoti = "select max(notification_id) as id,max(notification_title) as title,max(notification_content) as content,max(notification_datettime) as date from tbl_notification";
                    ResultSet rsNoti = con.selectCommand(selNoti);
                    if (rsNoti.next()) {
                %>
                <marquee class="marq" direction="left" loop="" onclick="window.location = 'HomePage.jsp?apply=<%=rsNoti.getString("id")%>'"> 

                    <div class="geek1"> 
                        <%=rsNoti.getString("title")%> 
                    </div> 
                    <div class="geek2"> 
                        (<%=rsNoti.getString("date")%>)<%=rsNoti.getString("content")%> 
                    </div> 
                    <a herf=""> 
                        Click To Apply Nomination
                    </a> 
                        ...
                        <div class="column is-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body no-padding">
                                    ...
                                    <%
                                        String selQry1 = "select * from tbl_student where student_id!='" + session.getAttribute("uid") + "'";
                                    ...
                                    <div class="story-block">
                                        <div class="img-wrapper">
                                            <img src="<%=rs1.getString("student_photo")%>" data-student-popover="1" alt="">
                                        </div>
        ...
        <script src="../Assets/friendskit/assets/js/popovers-students.js"></script>
