...
<html>
    ...
    <body>
        <div id="tab" align="center">
            ...
            <%
                String a = "0", b = "0";
                String one = "select count(complaint_status) as one from tbl_complaint where student_id='" + session.getAttribute("uid") + "' and complaint_status='0'";
                ResultSet ro = con.selectCommand(one);
                if (ro.next()) {
                    a = ro.getString("one");
                }
                String two = "select count(complaint_status) as two from tbl_complaint where student_id='" + session.getAttribute("uid") + "' and complaint_status='1'";
            ...
            <table>
                ...
                <%           String selQry = "select * from tbl_complaint where student_id='" + session.getAttribute("uid") + "' and complaint_status='0'";
                    int i = 0;
            ...
            <table>
                ...
                <%
                    String selQry1 = "select * from tbl_complaint where student_id='" + session.getAttribute("uid") + "' and complaint_status='1'";
