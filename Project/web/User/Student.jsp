...
<html lang="en" >
    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                     int i = 0;
                    String selQry = "select * from tbl_student s inner join tbl_place p on p.place_id=s.place_id inner join tbl_district dis on dis.district_id=p.district_id where s.student_id!='" + session.getAttribute("uid") + "'";
