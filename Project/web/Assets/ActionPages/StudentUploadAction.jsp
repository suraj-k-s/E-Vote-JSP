...
//checking if request cotains multipart data
    ...
    if (isMultipart) {
        ...
        if (value[10].equals(value[11])) {
            String InsQry = "INSERT INTO tbl_student( student_name,student_address,student_gender, student_contact,student_photo,student_proof,student_admissionid,student_email,course_id,semester_id,student_password)"
                    + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + photo + "','" + proof + "','" + value[4] + "','" + value[5] + "','" + value[6] + "','" + value[7] + "','" + value[10] + "')";
