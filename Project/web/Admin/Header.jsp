...
<nav class="sidebar">
    ...
    <ul id="sidebar_menu">
        ...
        <li class="">
            ...
            <ul>
                <li><a href="NewStudentList.jsp">New Student List</a></li>
                <li><a href="AcceptedStudentList.jsp">Accepted Student List</a></li>
                <li><a href="RejectedStudentList.jsp">Rejected Student List</a></li>
            </ul>
        </li>
        <li class="side_menu_title">
        ...
        <li class="">
            ...
            <ul>
                ...
                <li><a href="Position.jsp">Position</a></li>
        ...
        <li class="">
            <a   class="has-arrow" href="Candidate.jsp" aria-expanded="false">
                <img src="../Assets/admin/img/menu-icon/2.svg" alt="">
                <span>Candidate</span>
            </a>
        ...
        <li class="">
            <a   class="has-arrow" href="Polling.jsp" aria-expanded="false">
                <img src="../Assets/admin/img/menu-icon/2.svg" alt="">
                <span>Polling</span>
            </a>
        ...
        <li class="">
            <a   class="has-arrow" href="ViewStudentComplaint.jsp" aria-expanded="false">
                <img src="../Assets/admin/img/menu-icon/2.svg" alt="">
