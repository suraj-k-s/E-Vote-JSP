...
<html lang="en" >
    ...
    <%       
        if (request.getParameter("aid") != null) {
                ...
                String upQry = "update tbl_student set student_status='1' where student_id='" + request.getParameter("aid") + "'";
        ...
        if (request.getParameter("rid") != null) {
                ...
                String upQry = "update tbl_student set student_status='2' where student_id='" + request.getParameter("rid") + "'";
                if (con.executeCommand(upQry)) {
    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_student c inner join tbl_place p on p.place_id=c.place_id inner join tbl_district d on d.district_id=p.district_id where student_status='0'";
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="NewStudent.jsp?aid=<%=rs.getString("student_id")%>&mailid=<%=rs.getString("student_email")%>&name=<%=rs.getString("student_name")%>"><img src="../Assets/check.png" width="25" height="25"></a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="NewStudent.jsp?rid=<%=rs.getString("student_id")%>&mailid=<%=rs.getString("student_email")%>&name=<%=rs.getString("student_name")%>"><img src="../Assets/remove.png"  width="25" height="25"></a>
                    </td>
                </tr>
                <%
                    }
