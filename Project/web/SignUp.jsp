...
<html lang="en">
    ...
    <%        if (request.getParameter("btn_save") != null) {
            ...
            String insQry = "insert into tbl_student(student_name,student_contact,student_email,student_address,student_password,place_id,student_admissionid,semester_id,course_id,student_photo)"
                    + "values('" + request.getParameter("txt_name") + "','" + request.getParameter("txt_number") + "','" + request.getParameter("txt_email") + "',"
                    + "'" + request.getParameter("txt_address") + "','" + request.getParameter("txt_password") + "','" + request.getParameter("sel_place") + "',"
                    + "'" + request.getParameter("txt_id") + "','" + request.getParameter("sel_course") + "','" + request.getParameter("sel_semester") + "','" + request.getParameter("converted_photo") + "')";
            ...
            <div class="outer-panel">
                <div class="outer-panel-inner">
                    <div class="process-title">
                        <h2 id="step-title-1" class="step-title is-active" style="margin-top: 25px">Welcome to E-Vote.</h2>
                            ...
                            <div class="columns mt-4">
                                ...
                                <div class="column is-4">
                                    <div class="account-type">
                                        ...
                                        <h3>E-Vote</h3>
                                        <p>Create a E-Vote account to be able to do some awesome things.</p>
                                        <a class="button is-fullwidth process-button" data-step="step-dot-2">
                                            Continue
                                        </a>
                                    </div>
                        ...
                        <div id="signup-panel-2" class="process-panel-wrap is-narrow">
                            <div class="form-panel">
                                ...
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <input type="text" required="" class="input" id="txt_id" name="txt_id" placeholder="Enter Admission ID">
                                    </div>
                                </div>
                                ...
                                <div class="field">
                                    <label>Course</label>
                                    <div class="control">
                                        <select required="" class="input" id="sel_course" style="border: none;background: transparent" name="sel_course">
                                            <option value="">Select</option>
                                            <%                                            String disQry = "select * from tbl_course";
                                ...
                                <div class="field">
                                    <label>Semster</label>
                                    <div class="control">
                                        <select required="" class="input" id="sel_semseter" style="border: none;background: transparent" name="sel_semester">
                                            <option value="">Select</option>
                                            <%                                            String disQry1 = "select * from tbl_semester";
                                                ResultSet rs1 = con.selectCommand(disQry1);
                                                while (rs1.next()) {
                                            %>
                                            <option value="<%=rs1.getString("semester_id")%>"><%=rs1.getString("semester_name")%></option>
                                            <%
                                                }
