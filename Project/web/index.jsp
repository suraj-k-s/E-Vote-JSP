...
<html lang="en">
    ...
    <%
        ...
        if (request.getParameter("btn_login") != null) {
            ...
            String student = "select * from tbl_student where student_email ='" + email + "' and student_password='" + password + "'";
            ResultSet rsC = con.selectCommand(student);

            String officer = "select * from tbl_electionofficer where officer_email ='" + email + "' and officer_password='" + password + "'";
            ResultSet rsO = con.selectCommand(officer);
            ...
            if (rsA.next()) {
                ...
                session.setAttribute("oid", rsO.getString("officer_id"));
                session.setAttribute("oname", rsO.getString("officer_name"));
                response.sendRedirect("Officer/HomePage.jsp");
            } else if (rsC.next()) {
                if (rsC.getString("student_status").equals("1")) {

                    session.setAttribute("uid", rsC.getString("student_id"));
                    session.setAttribute("uname", rsC.getString("student_name"));
                    session.setAttribute("uphoto", rsC.getString("student_photo"));
                    session.setAttribute("uemail", rsC.getString("student_email"));
                    response.sendRedirect("User/HomePage.jsp");

                } else if (rsC.getString("student_status").equals("0")) {
    ...
    <%        } else if (rsC.getString("student_status").equals("2")) {
