<%-- 
    Document   : OfficeUploadAction.jsp
    Created on : 6 Feb, 2024, 2:18:28 PM
    Author     : USER
--%>
                ...
                while (itr.hasNext())//checking if there is any value in the position like rs.next()
                {
                    ...
                    } else//when it is an image or multipart
                    {
                        ...
                        if (field_name.equals("filephoto"))//write the name of image here it is img_product
                        {
                            ...
                            photo = "OfficerPhoto_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
                         ...
                         if (field_name.equals("fileproof"))//write the name of image here it is img_product
                        {
                            ...
                            proof = "OfficerProof_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
                            //creating a file object
...
//                if (value[7].equals(value[8])) {//Strinh str1="insert into tbl_user ()";//inserting file
                    String InsQry = "INSERT INTO tbl_electionofficer( officer_name, officer_contact,officer_email, officer_password,officer_proof,officer_photo,officer_address, officer_gender,place_id)"
                            + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + proof +"','" + photo +"','" +  value[4] + "','" + value[5] + "','" + value[6] + "')";
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../Admin/OfficerRegistration.jsp'
